"""Media Player Support for interface with a Legacy Samsung TV."""
...
SOURCES = {"1": ['KEY_TV', 'KEY_SOURCE', 'KEY_RIGHT', 'KEY_ENTER'], "2": ['KEY_TV', 'KEY_SOURCE', 'KEY_RIGHT', 'KEY_RIGHT', 'KEY_ENTER'], "3": ['KEY_TV', 'KEY_SOURCE', 'KEY_RIGHT', 'KEY_RIGHT', 'KEY_RIGHT', 'KEY_ENTER']}
