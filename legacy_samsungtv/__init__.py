"""INIT for Legacy Samsung TV integration."""
...
LEGACY_SAMSUNG_PLATFORM = [Platform.MEDIA_PLAYER, Platform.REMOTE]
...
async def async_setup_entry(hass: HomeAssistant, entry: SamsungTVConfigEntry) -> bool:
    ...
    await hass.config_entries.async_forward_entry_setups(entry, LEGACY_SAMSUNG_PLATFORM)
...
async def async_unload_entry(hass: HomeAssistant, entry: SamsungTVConfigEntry) -> bool:
    ...
    return await hass.config_entries.async_unload_platforms(entry, LEGACY_SAMSUNG_PLATFORM)
